...
export const surveysData: Survey[] = [
  {
    ...
    creatorName: "А. Бат", // Added
    creatorImageSrc: "/placeholder.svg?height=30&width=30", // Added
  },
  {
    id: "2",
